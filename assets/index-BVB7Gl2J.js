import{i as N,a as k,x as a,r as L,e as v,G as p,d as O,R as Y,O as V,f as z,A as E,W}from"./CheckoutPage-BM5MWDea.js";import{n as l,c as _,o as j,r as b}from"./if-defined-CsppdPyW.js";import{T as A,D as F}from"./index-mQ4WrMS7.js";import"./index-99bowMhV.js";import"./index-Cz3yHZnr.js";import"./index-TVhy3HKe.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
