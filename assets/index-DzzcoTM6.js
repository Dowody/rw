import{u as k,w as C,y as $,i as f,r as y,a as d,x as s,O as a,h as R}from"./CheckoutPage-uGMkkPqh.js";import{n as _,c as b,o as O,r as j}from"./if-defined-DXMzVV2F.js";import{e as P,n as U}from"./ref-CSCiApIx.js";import{R as T}from"./ConstantsUtil-Dmg8YACJ.js";const u=k({isLegalCheckboxChecked:!1}),x={state:u,subscribe(r){return $(u,()=>r(u))},subscribeKey(r,e){return C(u,r,e)},setIsLegalCheckboxChecked(r){u.isLegalCheckboxChecked=r}},L=f`
  label {
    display: flex;
    align-items: center;
    cursor: pointer;
